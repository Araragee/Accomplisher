      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-[1.6fr_1fr]">
        <Card className="overflow-hidden">
          <div className="border-b border-line p-4">
            ...
            <form onSubmit={addObjective} className="mt-3 flex flex-wrap gap-2">
                  ...
                  <ul className="divide-y divide-line">
                    {list.map((o) => (
                      <li key={o.id} className="group flex items-center gap-3 px-5 py-3">
                        <Select value={o.status} onChange={(v) => setStatus(o, v)} options={STATUS_OPTIONS} className="w-32" aria-label="Status" />
        ...
        <Card className="h-fit overflow-hidden">
          <div className="flex items-center justify-between border-b border-line p-4">
            ...
            <Button size="iconSm" variant="ghost" onClick={loadSuggestions} loading={thinking} aria-label="Refresh suggestions">
                ...
                <li key={s.id} className="px-4 py-3.5">
                  ...
                  <div className="mt-2 flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1.5">
                      <Button size="sm" variant="ghost" onClick={() => logSuggestion(s)}>Log</Button>
                      <Button size="sm" variant="soft" onClick={() => track(s)}>Track</Button>
                    </div>
                  </div>
                </li>
              ))}
