...
export function TeamPage() {
  ...
  return (
    <Page width="wide">
        ...
        {rows.map(({ member: m, coverage, logged }) => (
          <Card key={m.id} className="flex flex-col gap-4 p-4 sm:flex-row sm:items-center">
            ...
            <div className="flex items-center gap-1.5 sm:justify-end">
              ...
              <Button size="iconSm" variant="ghost" aria-label="Edit" onClick={() => setEditing({ id: m.id, name: m.name, role: m.role || '', created_at: m.createdAt })}>
      ...
      >
        {editing && (
          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); saveMember(); }}>
            <Field label="Name">
