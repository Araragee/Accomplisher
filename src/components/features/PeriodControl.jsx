...
import { buildCustomPeriod, currentCutoffPeriod, stepCutoff } from '../../lib/periods';

// Controlled period selector: Cutoff stepper (A/B through months) or a custom
// date range. `period` is a built period object; `onChange` receives a new one.
export function PeriodControl({ period, onChange }) {
